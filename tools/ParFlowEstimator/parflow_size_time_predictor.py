...
def main( argv=sys.argv ):
  ...
  parser.add_argument(
    ...
    nargs="*",
    default="",
    help="Arguments supplied to execute tcl script, if any."
  )
  parser.add_argument(
    "--exact-command",
    ...
    action="store_true",
    default=False,
    help="When set, execution_arguments will be executed exactly as specified, meaning no wrapping with tcl command will be used."
  )
  ...
  parser.add_argument(
    ...
    type=str,
    default=None,
    help=f"Name of output file. (Default: <file_path>{default_output_suffix})"
  )
  parser.add_argument(
    "--backup-suffix",
  ...
  parser.add_argument(
    "--replace-existing",
    # metavar="replace_existing",
    action="store_true",
    default=False,
    help="When set, moves renames input file with backup suffix, writes output file to input file's original path."
  )
  parser.add_argument(
    "--enable-clobber",
    # metavar="enable_clobber",
    action="store_true",
    default=False,
    help="When set, allows overwriting of existing files."
  )
  ...
  parser.add_argument(
    ...
    action="store_true",
    default=False,
    help="When set, program only generates the new TCL script without executing it."
  )
  ...
  parser.add_argument(
    ...
    type=str,
    default=None,
    help="Path to write report output to instead of standard out."
  )

  parser.add_argument(
    "--print-report-format",
    # metavar="print_report_format",
    default=False,
    action="store_true",
